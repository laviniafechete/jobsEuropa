...
export default function Footer() {
  ...
  const iconWrapper = "w-9 h-9 flex items-center justify-center";
  ...
  return (
    <footer className="w-full bg-white border-t py-6">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 px-2 sm:px-4">
        <div className="flex items-center gap-4 p-2">
          <a
            ...
            className={`${iconWrapper} text-gray-500 hover:text-blue-600`}
            aria-label="Mail"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`${iconWrapper} text-gray-500 hover:text-pink-500`}
          ...
          <a
            ...
            aria-label="TikTok"
          >
            <img src={tiktok} alt="TikTok" className="w-6 h-6 object-contain" />
          </a>
        </div>
        ...
        <div className="flex flex-wrap gap-4 justify-center mt-2 text-sm text-gray-500">
          ...
          <a href="/newsletter-policy" className="hover:underline">
            Politica de Newsletter
          </a>
      ...
      <span className="text-xs text-gray-400 text-center md:text-right mt-4">
        &copy; {new Date().getFullYear()} Jobs Europa. Toate drepturile rezervate.
      </span>
    </footer>
  );
}
